...
define ('BASE_URL', 'http://10.136.212.37/gjschorgl/assignment7/');
...
function my_error_handler ($e_number, $e_message, $e_file, $e_line, $e_vars) {
	...
	if (!LIVE) { // Development (print the error).
		...
		if ($e_number != E_NOTICE) {
			echo '<div class="alert alert-danger">A system error occurred. We apologize for the inconvenience.</div><br />';
		}
	} // End of !LIVE IF.
